...
var wrapper;
describe("Given the FeatureContentVertical component", function () {
    describe("When it is rendered", function () {
        beforeEach(function () {
            wrapper = renderWithProviders(React.createElement(FeatureContentVertical, { header: "Header", body: "Body", actions: React.createElement(Button, null, "View"), media: "Image" }));
        });
...
//# sourceMappingURL=FeatureContentVertical.test.js.map