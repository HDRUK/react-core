...
var FeatureContentVertical = function (_a) {
    ...
    return (_jsx(Card, __assign({}, outerProps, { maxWidth: "284px", className: "ui-FeatureContentVertical" }, { children: _jsx(CardBody, { children: _jsxs("div", __assign({ css: styles.root }, { children: [header && (_jsx(FeatureContentHeader, __assign({ mb: 3 }, { children: header }))), _jsx("div", __assign({ css: styles.media }, { children: media })), body && _jsx(FeatureContentBody, __assign({ mb: 4 }, { children: body })), actions && (_jsx(FeatureContentActions, __assign({ textAlign: "center" }, { children: actions })))] })) }) })));
};
